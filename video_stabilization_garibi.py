...
from utils_garibi import parse_video, get_video_writer
...
class Stabilizer:
    def __init__(self, capture: cv2.VideoCapture, output_path: str):
        ...
        self.out_writer = get_video_writer(output_path, self.video_parameters, True)
...
s = Stabilizer(vid_input, STABILIZED_VIDEO_PATH)
s.apply_stabilization()